...
// Local copy of the LayoutBasics structure for golden capture
class TestLayoutBasics extends StatelessWidget {
  const TestLayoutBasics({super.key});
