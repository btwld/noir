...
Start with [`tasks/READ_HERE.md`](tasks/READ_HERE.md). It describes the current
workflow, allowed checks, and release-readiness record. [`GOALS.md`](GOALS.md)
defines the durable architecture and quality bar.
...
[`tasks/release-readiness.md`](tasks/release-readiness.md).
