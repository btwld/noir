...
`runTuiApp(app, enableMouse: true)`. The unreleased candidate includes movement
...
Mouse pointer shapes require the unreleased Noir candidate. Use the checkout
instructions in [Installation](/docs/installation) before copying this API.
The pointer is the desktop mouse shape, separate from the text caret.
...
[focus form example](https://github.com/conceptadev/noir/blob/main/example/focus_form.dart)
