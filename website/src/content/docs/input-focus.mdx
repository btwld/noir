...
`runTuiApp(app, enableMouse: true)`, and request movement events separately
only when the app needs hover or drag. A terminal that does not report mouse
input cannot be made to; see
