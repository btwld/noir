...
export const terminalFrames: Record<string, TerminalFrameData> = {
  'first-app-count': {
    ...
    entrypoint: 'packages/noir/example/tutorials/first_app/step_01.dart',
    width: 40,
    height: 6,
  ...
  'first-app-total': {
    ...
    command: 'dart run noir:run bin/noir_demo.dart',
    entrypoint: 'packages/noir/example/tutorials/first_app/step_02.dart',
    width: 40,
    height: 6,
  ...
  'task-list-complete': {
    ...
    runs: [
      ...
      [
        ...
        {
          text: 'Tab moves · Space toggles · Ctrl+C exits',
          fg: '#999999',
          bg: '#090a0b',
        },
        {
  ...
  'task-list-add': {
    ...
    runs: [
      ...
      [
        ...
        {
          text: 'Enter adds · Tab moves · Space toggles · Ctrl+C exits',
          fg: '#999999',
          bg: '#090a0b',
        },
        {
