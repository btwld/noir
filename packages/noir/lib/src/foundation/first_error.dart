...
///
/// Framework- and app-layer teardown paths share this first-error-wins shape:
/// every action is attempted, later failures are swallowed, and the earliest
/// error escapes after the whole sequence (and any `finally` state reset) has
/// run. Internal to the framework — not exported from any barrel.
@internal
