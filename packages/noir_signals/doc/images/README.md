...
[`packages/noir/tool/recordings/doc_frames.json`](https://github.com/btwld/noir/blob/main/packages/noir/tool/recordings/doc_frames.json)
...
[`record_noir_demo.dart`](https://github.com/btwld/noir/blob/main/packages/noir/tool/record_noir_demo.dart)
