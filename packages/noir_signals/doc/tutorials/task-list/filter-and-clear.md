...
![Lesson 5: Hide completed is checked, only Build a Signals app and Ship the guide are visible, and the summary reads 2 of 4 remaining.](../../images/05-filter.jpg)
...
![Lesson 5 after Clear completed: the same two rows remain, the summary reads 2 of 2 remaining, and Clear completed is disabled.](../../images/06-clear.jpg)
...
Previous: [Add a task](./add-a-task.md).
